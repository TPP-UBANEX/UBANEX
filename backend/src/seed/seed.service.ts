...
export class SeedService {
  ...
  private seedDatosFormulario(opts: {
    ...
    const [campoResumen, campoAntecedentes, campoArea, campoPoblaciones, campoCronograma] = this.camposFormularioEstandar;
    const [colActividad, colFecha, colResponsable] = campoCronograma?.columnas ?? [];
    const base = {
