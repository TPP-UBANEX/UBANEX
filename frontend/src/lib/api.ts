...
export const api = {
  ...
  participaciones: {
    ...
    actualizarEstado: (id: string, estado: import('@/data/types').EstadoPropuestaEvaluador) =>
      patch<import('@/data/types').ParticipacionConvocatoria>(
        `/participaciones-convocatoria/${id}/estado`,
        { estado },
      ),
    aceptar: (id: string) =>
      post<import('@/data/types').ParticipacionConvocatoria>(
        `/participaciones-convocatoria/${id}/aceptar`,
        {},
      ),
    declinar: (id: string) =>
      post<import('@/data/types').ParticipacionConvocatoria>(
        `/participaciones-convocatoria/${id}/declinar`,
        {},
      ),
