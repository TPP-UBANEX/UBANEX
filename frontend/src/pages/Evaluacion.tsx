                          ...
                          <Dialog open={open && selected?.id === e.id} onOpenChange={(v) => { setOpen(v); if (v) setSelected(e) }}>
                            ...
                            <DialogContent>
                              ...
                              <div className="space-y-4 pt-4">
                                <div className="text-sm"><span className="text-muted-foreground">Tipo:</span> {e.tipo} · <span className="text-muted-foreground">Usuario evaluador:</span> {e.evaluador}</div>
